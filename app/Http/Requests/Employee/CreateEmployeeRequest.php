...
class CreateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $asnRules = [
            ...
            'employee_registration_number' => 'nullable|numeric|min:00000|max:9999999999|unique:users,employee_registration_number',
            ...
            'employee_id_card_number' => 'nullable|min:00000|max:9999999999|unique:users,employee_id_card_number',
            'employee_id_card' => 'nullable|file|extensions:jpg,jpeg,png,pdf|max:2048',
            'karisu_number' => 'nullable|numeric|min:00000|max:9999999999|unique:users,karisu_number',

...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $asnRules = [
            ...
            'employee_id_number' => 'required|numeric|min:00000|max:999999999999999999|unique:users,employee_id_number,' . $this->id,
            ...
            'karisu_number' => 'nullable||numeric|min:00000|max:999999999999999999|unique:users,karisu_number,' . $this->id,
            'id_tax' => 'nullable|max:16|unique:users,id_tax,' . $this->id,
            'employment_status' => 'required|numeric',
            'family_registration_number' => 'nullable|numeric|digits:16|unique:users,family_registration_number,' . $this->id,
        ...
        $nonASNRules = [
            ...
            'institution_id'                => 'required|numeric',
            'education_level'               => 'required|numeric|in:1,2,3,4,5,6,7,8',
            'education_name'                => 'max:160',
            'education_year'                => 'date_format:Y',
            'employee_id_card_number'       => 'nullable|min:00000|max:999999999999999999|unique:users,employee_id_card_number,' . $this->id,
            'employee_id_card'              => 'nullable|file|extensions:jpg,jpeg,png,pdf|max:2048',
            'karisu_number'                 => 'nullable|numeric|min:00000|max:999999999999999999|unique:users,karisu_number,' . $this->id,
            'id_tax'                        => 'nullable|max:16|unique:users,id_tax,' . $this->id,
    ...
    public function messages(): array
    {
        $userMessages = [
            ...
            'karisu_number.numeric' => 'Nomor kartu suami/istri harus berupa angka.',
            'karisu_number.min' => 'Nomor kartu suami/istri tidak boleh kurang dari 5 digit angka.',
            'karisu_number.max' => 'Nomor kartu suami/istri tidak boleh lebih dari 10 digit angka.',

...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $asnRules = [
            ...
            'employee_registration_number' => 'nullable|numeric|min:00000|max:9999999999|unique:users,employee_registration_number,' . $this->id,
            ...
            'karisu_number' => 'nullable||numeric|min:00000|max:9999999999|unique:users,karisu_number,' . $this->id,

...
class UpdateDisciplinaryHistoryEmployeeRequest
{
    ...
    public static function messages(): array
    {
        return [
            ...
            'disciplinaries.*.start_date.required' => 'Tanggal mulai hukuman tidak boleh kosong.',
            'disciplinaries.*.start_date.date' => 'Tanggal mulai hukuman harus berupa tanggal.',
            'disciplinaries.*.end_date.required' => 'Tanggal selesai hukuman tidak boleh kosong.',

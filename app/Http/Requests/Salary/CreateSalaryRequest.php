...
class CreateSalaryRequest
{
    ...
    {
        return [
            'salaries.*.period_month' => 'numeric|digits_between:1,12',
            'salaries.*.period_year' => 'date_format:Y',
            'salaries.*.grade_id' => 'numeric',
            'salaries.*.effective_date' => 'date',
            'salaries.*.decree_number' => 'max:160',
            'salaries.*.length_of_service_month' => 'numeric|digits_between:1,12',
            'salaries.*.length_of_service_year' => 'date_format:Y',
            'salaries.*.previous_basic_salary' => 'numeric',
            'salaries.*.new_basic_salary' => 'numeric',

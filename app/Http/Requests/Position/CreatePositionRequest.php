...
class CreatePositionRequest
{
    ...
    {
        return [
            'positions.*.period_month' => 'numeric|digits_between:1,12',
            'positions.*.period_year' => 'date_format:Y',
            'positions.*.position_id' => 'numeric',
            'positions.*.group_id' => 'numeric',
            'positions.*.effective_date' => 'date',
            'positions.*.decree' => 'max:160',
            'positions.*.decree_document' => 'file|extensions:jpg,jpeg,png,pdf|max:2048',
            'positions.*.type_of_decree' => 'numeric',

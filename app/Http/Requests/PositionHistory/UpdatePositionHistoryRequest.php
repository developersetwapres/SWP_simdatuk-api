...
class UpdatePositionHistoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'users.*.echelon' => 'numeric|in:1,2,3,4,5,6|nullable',
            ...
            'users.*.termination_date' => 'date|nullable',
            'users.*.termination_decree' => 'max:160|nullable',
            'users.*.type_of_termination_decree' => 'numeric|nullable',
            'users.*.termination_decree_number' => 'max:160|nullable',
            'users.*.termination_decree_date' => 'date|nullable',

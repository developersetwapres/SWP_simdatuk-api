...
use App\Http\Requests\Disciplinary\CreateDisciplinaryRequest;
use App\Http\Requests\Disciplinary\UpdateDisciplinaryRequest;
...
class DisciplinaryController extends Controller
{
     ...
     */
    public function create(CreateDisciplinaryRequest $request)
    {
        try {
            DB::beginTransaction();
     ...
     */
    public function update(UpdateDisciplinaryRequest $request)
    {
        $disciplinary = DB::table('disciplinaries');
        $disciplinary->where('id', $this->request->id);

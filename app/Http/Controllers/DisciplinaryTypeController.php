...
/**
 * @group Master Data
 * @subgroupDescription These endpoints allow you to perform CRUD operations on disciplinary type data, enabling the retrieval, creation, updating and deleting of disciplinary type records as needed.
 */
class DisciplinaryTypeController extends Controller
{
    ...
    /**
     * Get List of Disciplinary Types
     *
     * Retrieve the disciplinary type of master data.
     * @subgroup Disciplinary Type
     * @authenticated
